...
### 智慧农田感知与无人系统 
<span class="interest-subtitle">Smart Farmland Sensing & Unmanned Systems</span>
...
<source src="{{ site.url }}{{ site.baseurl }}/images/research_figures/robot_dog_field.mp4" type="video/mp4">
</video>
<p style="text-align: center; font-size: 0.85rem; color: #777; margin-top: 4px;">机器狗田间巡检 <em>Robot Dog Field Inspection</em></p>
</div>
<div style="width: 49%;">
<video width="100%" autoplay loop muted playsinline style="border-radius: 8px; display: block;">
<source src="{{ site.url }}{{ site.baseurl }}/images/research_figures/robot_dog_angle.mp4" type="video/mp4">
</video>
<p style="text-align: center; font-size: 0.85rem; color: #777; margin-top: 4px;">机器狗视角 <em>Robot Dog Perspective</em></p>
</div>
</div>

<div style="display: flex; gap: 10px; margin-top: 12px;">
<div style="width: 49%;">
<img src="{{ site.url }}{{ site.baseurl }}/images/research_figures/path.gif" width="100%" style="border-radius: 8px; display: block;" alt="RTK导航" />
<p style="text-align: center; font-size: 0.85rem; color: #777; margin-top: 4px;">RTK导航 <em>RTK Navigation</em></p>
</div>
<div style="width: 49%;">
<video width="100%" autoplay loop muted playsinline style="border-radius: 8px; display: block;">
<source src="{{ site.url }}{{ site.baseurl }}/images/research_figures/robot_dog_test_web.mp4" type="video/mp4">
</video>
<p style="text-align: center; font-size: 0.85rem; color: #777; margin-top: 4px;">RTK导航测试 <em>RTK Navigation Test</em></p>
</div>
</div>
...
### 精准灌溉与水肥一体化智能装备 
<span class="interest-subtitle">Precision Irrigation & Water-Fertilizer Equipment</span>
...
<img
  src="{{site.url}}{{site.baseurl}}/images/research_figures/injections.gif"
  width="100%"
...
### 农业水动力学与数值模拟 
<span class="interest-subtitle">Agricultural Hydrodynamics & Numerical Simulation</span>
...
### 农业水土系统建模与可持续性评价 
<span class="interest-subtitle">Water-Soil System Modeling & Sustainability</span>
